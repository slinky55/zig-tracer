...
test "Vector Creation" {
    ...
    const value = Vec4.Vector(x, y, z);

    try expect(value.w == 0);
}

test "Vec4 Addition" {
    const vec1 = Vec4.Vector(1, 2, 3);
    const vec2 = Vec4.Vector(1, 2, 3);

    const expected = Vec4.Vector(2, 4, 6);
...
test "Vec4 Subtraction" {
    const vec1 = Vec4.Vector(2, 4, 6);
    const vec2 = Vec4.Vector(1, 2, 3);

    const expected = Vec4.Vector(1, 2, 3);
...
test "Vec4 Scaling" {
    ...
    const expected1 = Vec4.Vector(2, 4, 6);
    const actual1 = vec1.Scale(scalar1);

    try expect(VectorEquals(expected1, actual1));

    const vec2 = Vec4.Vector(2, 4, 6);
    const scalar2 = 0.5;

    const expected2 = Vec4.Vector(1, 2, 3);
...
test "Vector Cross Product" {
    ...
    const expected = Vec4.Vector(-3, 6, -3);
